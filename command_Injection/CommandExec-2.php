<html>
  ...
  <body>
    ...
    <form align="center" action="CommandExec-2.php" method="$_GET">
      ...
      <!-- Sửa thành POST để giấu thông tin truyền đi và ngăn chặn việc hiển thị trên URL. -->
      <!-- <form align="center" action="CommandExec-2.php" method="post"> -->
  ...
  <div style="background-color:#ecf2d0;padding:20px;border-radius:0px 0px 20px 20px" align="center">
    ...
    if(isset($_GET["typeBox"])){
      ...
      // Hàm filter_var với FILTER_SANITIZE_STRING giúp loại bỏ các ký tự đặc biệt từ đầu vào người dùng,
 
      $substitutions = array('&&' => '',';'  => '','/' => '','\\' => '' );
      $target = str_replace(array_keys($substitutions),$substitutions,$target);
      echo shell_exec($target);
 
      // Hàm escapeshellcmd được sử dụng để tránh Command Injection bằng cách "chuẩn hóa" các ký tự đặc biệt trong lệnh shell
  ...
  //     echo "Welldone! You did a great job.";
  // }
  // Sử dụng so sánh === để đảm bảo so sánh giá trị và kiểu dữ liệu một cách chính xác.
